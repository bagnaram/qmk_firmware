...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Base */
    [_DVORAK] = LAYOUT(
        KC_ESCAPE,    KC_1,    KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,  KC_9,   KC_LBRACKET,   KC_RBRACKET,   KC_BSPACE,   KC_DEL,
        ...
        KC_LSHIFT, KC_SCOLON,   KC_Q,   KC_J,   KC_K,   KC_K,   KC_X,   KX_B,   KX_M,   KX_W,  KC_V,   KC_Z,          KC_RSHIFT,     KC_UP,       KC_PGDN,
        KC_LCTRL,     LGUI,    KC_ALT, KC_SPACE, KC_RALT, KC_FN, KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    [_FN] = LAYOUT(
